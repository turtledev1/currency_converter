...
class _CameraViewState extends State<CameraView> {
  ...
  DateTime? _lastImageProcessedDateTime;
  final int _throttleMs = 1000;
  ...
  void _processCameraImage(CameraImage image) {
    ...
    if (_lastImageProcessedDateTime != null &&
        now.difference(_lastImageProcessedDateTime!).inMilliseconds < _throttleMs) {
      return;
    }
    _lastImageProcessedDateTime = now;
